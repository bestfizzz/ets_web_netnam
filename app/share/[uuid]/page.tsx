...
import { ShareTemplateDetail,ShareTemplateJsonConfig } from "@/lib/types/types"
...
export default async function SharePage({
  ...
  let isValid
  let templateData: ShareTemplateDetail
  ...
  return (
    <TemplateGenerator
      content={content}
      settings={(templateData.jsonConfig as ShareTemplateJsonConfig).settings}
      pageName={
