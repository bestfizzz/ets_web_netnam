...
export function AddPlatformModal() {
    ...
    const handleAddPlatform = async () => {
        ...
        setLoading(true)
        try {
            const res = await fetch("/api/share/platforms", {
                method: "POST",
...
export function EditPlatformModal({ id, name }: EditPlatformModalProps) {
    ...
    const handleSave = async () => {
        ...
        setLoading(true)
        try {
            const res = await fetch(`/api/share/platforms/${id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
        ...
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Are you sure you want to delete <span className="font-medium">{name}</span>?<br />
